...
from .views import SnackListView, SnackDetailView, SnackCreateView, SnackUpdateView, SnackUpdateView
...
urlpatterns = [
    ...
    path('delete-snack/<int:pk>', SnackUpdateView.as_view(), name='snack_delete'),
]